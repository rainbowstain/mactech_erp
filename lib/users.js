...
export const USER_ROLES = [
  ...
  },
  {
    value: "finanzas",
    label: "Finanzas",
    description: "Control financiero, reportes, gastos y lectura de ventas/OT.",
...
// Eliminar órdenes y ajustar costos de OT cerradas (finanzas): solo admin o developer.
export function canDeleteOrders(session) {
  return USER_MANAGERS.has(normalizeUserRole(session?.role));
}
